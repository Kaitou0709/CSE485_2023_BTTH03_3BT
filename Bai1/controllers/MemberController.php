        ...
        if (isset($_POST['btnSignIn'])) {
            if (empty($_POST['txtUser']) || empty(($_POST['txtMail'])) || empty(($_POST['txtPass'])) || empty(($_POST['txtPass1']))) {
                ...
                if (count($check) != 0) {
                    ...
                    $path = '<a href="localhost/CSE485_2023_BTTH03_3BT/Bai1/index.php?email=' . $email . '&active=' . $code_hash . '&controller=Member&action=active' . '"><button">Kích hoạt tài khoản</button></a>';
